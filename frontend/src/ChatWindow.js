...
// //     // If escalation exists, send via WebSocket
// //     if (currentEscalationId) {
// //       if (wsConnected && wsRef.current?.readyState === WebSocket.OPEN) {
// //         wsRef.current.send(JSON.stringify({ 
// //           type: "message", 
...
// //         // FIXED: Check if this is an order list response
// //         if (data.reply === "ORDER_LIST" && data.orders && Array.isArray(data.orders)) {
// //           console.log("Displaying order cards:", data.orders);
// //           setMessages(prev => [...prev, { 
// //             sender: "bot", 
// //             text: "Here are your recent orders:",
// //             orders: data.orders,
...
//     // If escalation exists, send via WebSocket ONLY
//     if (currentEscalationId) {
//       if (wsConnected && wsRef.current?.readyState === WebSocket.OPEN) {
//         wsRef.current.send(JSON.stringify({ 
//           type: "message", 
...
//         // Check if this is an order list response
//         if (data.reply === "ORDER_LIST" && data.orders && Array.isArray(data.orders)) {
//           console.log("✅ Displaying order cards:", data.orders.length, "orders");
//           setMessages(prev => [...prev, { 
//             sender: "bot", 
//             text: "Here are your recent orders:",
//             orders: data.orders,
...
//         setMessages(prev => [...prev, { 
//           sender: "bot", 
//           text: errorData.detail || "Sorry, an error occurred. Please try again.", 
//           timestamp: new Date().toISOString() 
//         }]);
//       }
//     } catch (error) {
...
// const styles = {
//   container: { maxWidth: "1200px", margin: "0 auto", padding: "20px", fontFamily: "'Inter', sans-serif", height: "calc(100vh - 40px)", display: "flex", flexDirection: "column" },
//   header: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "15px", paddingBottom: "15px", borderBottom: "2px solid #e0e0e0" },
//   title: { margin: 0, fontSize: "1.5rem", color: "#333" },
//   modeIndicator: { margin: "4px 0 0 0", fontSize: "0.85rem", color: "#4caf50", fontWeight: "500" },
//   statusContainer: { display: "flex", gap: "0.5rem" },
//   statusIndicator: { display: "flex", alignItems: "center", gap: "0.5rem", fontSize: "0.9rem", color: "#666", background: "#e8f5e9", padding: "0.5rem 1rem", borderRadius: "20px", fontWeight: "500" },
//   statusIndicatorGray: { display: "flex", alignItems: "center", gap: "0.5rem", fontSize: "0.9rem", color: "#666", background: "#f5f5f5", padding: "0.5rem 1rem", borderRadius: "20px" },
//   statusIndicatorOff: { display: "flex", alignItems: "center", gap: "0.5rem", fontSize: "0.9rem", color: "#666", background: "#fff3e0", padding: "0.5rem 1rem", borderRadius: "20px" },
//   greenDot: { color: "#4caf50", fontSize: "1.2rem" },
//   grayDot: { color: "#999", fontSize: "1.2rem" },
//   yellowDot: { color: "#ff9800", fontSize: "1.2rem" },
//   chatBox: { border: "1px solid #ddd", borderRadius: "12px", flex: 1, overflowY: "auto", padding: "24px", marginBottom: "15px", backgroundColor: "#fafafa", minHeight: 0 },
//   emptyState: { textAlign: "center", padding: "4rem 2rem", color: "#666" },
//   emptyHint: { fontSize: "0.9rem", color: "#999", marginTop: "0.5rem" },
//   message: { padding: "14px 18px", marginBottom: "14px", borderRadius: "12px", maxWidth: "85%", wordWrap: "break-word", lineHeight: "1.6", fontSize: "0.95rem", minWidth: "300px" },
//   userMessage: { backgroundColor: "#667eea", color: "white", marginLeft: "auto", borderBottomRightRadius: "4px", maxWidth: "70%" },
//   botMessage: { backgroundColor: "white", color: "#333", border: "1px solid #e0e0e0", borderBottomLeftRadius: "4px", maxWidth: "85%" },
//   systemMessage: { backgroundColor: "#fff3cd", color: "#856404", border: "1px solid #ffc107", textAlign: "center", margin: "1rem auto", maxWidth: "85%", fontSize: "0.9rem" },
//   agentBadge: { display: "inline-block", background: "#4caf50", color: "white", padding: "3px 10px", borderRadius: "12px", fontSize: "0.75rem", fontWeight: "600", marginBottom: "6px" },
//   timestamp: { fontSize: "0.7rem", color: "#999", marginTop: "6px" },
//   loadingMessage: { backgroundColor: "white", color: "#666", padding: "12px 16px", borderRadius: "12px", maxWidth: "75px", border: "1px solid #e0e0e0" },
//   typingDots: { display: "flex", gap: "4px", fontSize: "1.5rem" },
//   inputArea: { display: "flex", gap: "12px", padding: "8px 0" },
//   input: { flex: 1, padding: "14px 18px", border: "2px solid #ddd", borderRadius: "10px", fontSize: "1rem", outline: "none", transition: "border-color 0.2s", fontFamily: "'Inter', sans-serif" },
//   sendButton: { padding: "14px 40px", backgroundColor: "#667eea", color: "white", border: "none", borderRadius: "10px", cursor: "pointer", fontSize: "1rem", fontWeight: "600", transition: "all 0.2s", minWidth: "120px" },
//   sendButtonDisabled: { backgroundColor: "#ccc", cursor: "not-allowed" },
//   orderCardsContainer: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: "1.25rem", marginTop: "0.75rem", marginBottom: "1rem", width: "100%" },
//   orderCard: { backgroundColor: "white", border: "2px solid #e0e0e0", borderRadius: "12px", padding: "1.25rem", cursor: "pointer", transition: "all 0.3s ease", boxShadow: "0 2px 6px rgba(0,0,0,0.08)" },
//   orderHeader: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.875rem" },
//   orderRestaurant: { fontWeight: "600", fontSize: "1.05rem", color: "#333", flex: 1 },
//   orderStatus: { padding: "0.35rem 0.65rem", borderRadius: "6px", fontSize: "0.8rem", fontWeight: "600", color: "white", whiteSpace: "nowrap", marginLeft: "0.75rem" },
//   orderItems: { fontSize: "0.9rem", color: "#666", marginBottom: "0.875rem", lineHeight: "1.5" },
//   orderDetails: { display: "flex", flexDirection: "column", gap: "0.35rem", marginBottom: "0.875rem", fontSize: "0.85rem", color: "#555" },
//   orderDetailRow: { display: "flex", alignItems: "center" },
//   orderTotal: { fontWeight: "700", fontSize: "0.95rem", color: "#333" },
//   orderFooter: { fontSize: "0.8rem", color: "#999", borderTop: "1px solid #f0f0f0", paddingTop: "0.65rem", marginTop: "0.65rem" },
//   clickHint: { fontSize: "0.75rem", color: "#667eea", textAlign: "center", marginTop: "0.65rem", fontStyle: "italic" }
// };
...
// THIS IS THE CORRECT AND FINAL VERSION. COPY AND PASTE THIS ENTIRE FILE.
