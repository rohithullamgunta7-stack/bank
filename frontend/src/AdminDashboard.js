        ...
        <div style={styles.statsGrid}>
          ...
          <div style={{...styles.statCard, ...styles.statCardGreen}}>
            ...
            <div>
              ...
              <div style={styles.statNumber}>
                {dashboardData?.user_roles_count?.support_agents || 0}
              </div>
          ...
          <div style={{...styles.statCard, ...styles.statCardOrange}}>
            ...
            <div>
              ...
              <div style={styles.statNumber}>
                {dashboardData?.user_roles_count?.admins || 0}
              </div>
          ...
          <div style={{...styles.statCard, ...styles.statCardTeal}}>
            ...
            <div>
              ...
              <div style={styles.statNumber}>{dashboardData?.total_accounts || 0}</div>
              <p style={styles.statSubtext}>Bank accounts</p>
            </div>
          </div>
          ...
          <div style={{...styles.statCard, ...styles.statCardRed}}>
            ...
            <div>
              ...
              <div style={styles.statNumber}>{dashboardData?.total_transactions || 0}</div>
